      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          ...
          <div className="lg:col-span-2">
            <Link to="/#home" className="inline-flex items-center mb-6">
              <motion.div className="inline-flex items-center" whileHover={{ scale: 1.05 }}>
                <img
                  src={eglafLogo}
            ...
            <p className="text-muted-foreground mb-6 max-w-sm leading-relaxed">
              Transforming businesses through innovative technology solutions. We build the future of digital
              innovation.
            </p>
        ...
        <div className="pt-8 border-t border-border">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-muted-foreground">© 2026 Eglaf Technology LLP. All rights reserved.</p>
